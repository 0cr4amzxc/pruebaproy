...
function test3() {
  ...
  const questions = [
    ...
    "¿ Evitas topar ciertos temas o hacer ciertas cosas por temor a la reacción de tu pareja ?",
    "¿ Sientes culpa o responsabilidad por las reacciones violentas de quien te agrede ?",
    "¿ Tienes conocimiento si tu pareja ha violentado a parejas anteriores ?",
    ...
    "¿ Sientes que tu pareja tiene la razón en sus criticas, quejas, o reclamos contra !! ?",
    "¿ Tienes relaciones sexuales sin consentimientos ?",
    "¿ Te amenaza con quitarte a tus hijos o tus bienes si terminas la relación o denuncias ?",
    "¿ Ha vuelto a agredirte después de haber prometido que no to vuelve a hacer ?",
  ];
        ...
        <div className="container flex flex-col items-center sm:items-start gap-3">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-primary">
            ...
            <span className="text-lg sm:text-2xl">
              Fase 2 - ¡BUSCA AYUDA! Esto no es tu culpa
            </span>
          </div>
